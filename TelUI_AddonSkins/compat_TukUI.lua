...
if IsAddOnLoaded("TelUI") or Mod_AddonSkins or not IsAddOnLoaded("Tukui") or not Tukui then return end
...
Mod_AddonSkins.borderWidth = T.mult
...
CustomSkin = setmetatable(CustomSkin or {},Mod_AddonSkins)
...
if not CustomSkin.PositionSexyCooldownBar then
	function CustomSkin:PositionSexyCooldownBar(bar)
		if bar.settings.bar.name == "actionbar" then
			...
			bar:SetHeight(self.buttonSize+self.buttonSpacing*2)
			bar:SetPoint("BOTTOMLEFT",TukuiBar2,"TOPLEFT",0,self.buttonSpacing)
			bar:SetPoint("BOTTOMRIGHT",TukuiBar3,"TOPRIGHT",0,self.buttonSpacing)
			InvTukuiActionBarBackground:ClearAllPoints()
			if not T.lowversion then
				bar:SetPoint("BOTTOMLEFT",TukuiBar2,"TOPLEFT",0,self.buttonSpacing)
				bar:SetPoint("BOTTOMRIGHT",TukuiBar3,"TOPRIGHT",0,self.buttonSpacing)
				InvTukuiActionBarBackground:SetPoint("TOPLEFT",TukuiBar2,"TOPLEFT",0,self.buttonSpacing*2+self.buttonSize)
				InvTukuiActionBarBackground:SetPoint("BOTTOMRIGHT", TukuiBar3, "BOTTOMRIGHT")
			else
				bar:SetPoint("BOTTOMLEFT",TukuiBar1,"TOPLEFT",0,self.buttonSpacing)
				bar:SetPoint("BOTTOMRIGHT",TukuiBar1,"TOPRIGHT",0,self.buttonSpacing)
				InvTukuiActionBarBackground:SetPoint("TOPLEFT", TukuiBar1,"TOPLEFT",0,self.buttonSpacing*2+self.buttonSize)
				InvTukuiActionBarBackground:SetPoint("BOTTOMRIGHT", TukuiBar1, "BOTTOMRIGHT")
			end
